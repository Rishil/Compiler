...
#define aNumber 259
#define typeOfInput 260
#define anIdentifier 261
...
{
       0,     0,     3,    10,    13,    16,    17,    21,    25,    29,
      35,    37,    40,    41,    46,    51,    56,    60,    64,    68,
      72,    74
};
...
{
      19,     0,    -1,     7,    11,    12,    13,    20,    14,    -1,
      21,    24,    -1,    22,    21,    -1,    -1,     9,    23,    15,
      -1,    23,    16,    10,    -1,    10,    17,     8,    -1,    23,
      16,    10,    17,     8,    -1,    10,    -1,    25,    24,    -1,
      -1,    10,    17,     8,    15,    -1,    10,    17,    10,    15,
      -1,    10,    17,    26,    15,    -1,    26,     3,    26,    -1,
      26,     4,    26,    -1,    26,     5,    26,    -1,    26,     6,
      26,    -1,    10,    -1,     8,    -1
};
...
{
       0,    74,    74,    76,    78,    79,    81,    84,    91,    98,
     105,   113,   114,   117,   130,   140,   146,   154,   162,   170,
     179,   187
};
#endif
...
{
  "$end", "error", "$undefined", "'+'", "'-'", "'*'", "'/'",
  "mainFunction", "aNumber", "typeOfInput", "anIdentifier", "'('", "')'",
  "'{'", "'}'", "';'", "','", "'='", "$accept", "prg", "body", "varstmt",
  "vardecl", "theVariables", "listOfStatements", "aStatement",
  "expression", 0
};
#endif
...
{
      11,     6,    19,     8,   -28,     9,    12,    13,    14,    15,
      12,     7,    -2,   -28,    16,   -28,    15,   -28,    18,   -28,
      17,     0,   -28,   -28,    20,    21,    23,    -3,    22,   -28,
     -28,     1,     1,     1,     1,   -28,   -28,   -28,   -28,    10,
      10,   -28,   -28
};
...
{
      31,    32,    33,    34,    39,    40,    41,    42,    25,    37,
      26,    38,    35,    19,    20,    33,    34,     3,     1,     4,
       5,     7,     6,    11,    18,    14,    23,    24,    13,     0,
      36,     0,     0,    21,    17,     0,    29,    28,    30,     0,
       0,    22
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,    31,    32,    33,    34,     8,     8,
      10,    10,    15,    15,    16,     5,     6,    11,     7,     0,
      12,     9,    13,    10,    17,    10,     8,    10,    14,    -1,
       8,    -1,    -1,    17,    10,    -1,    15,    17,    15,    -1,
      -1,    16
};
...
{
       0,     7,    19,    11,     0,    12,    13,     9,    20,    21,
      22,    10,    23,    14,    10,    24,    25,    21,    17,    15,
      16,    17,    24,     8,    10,     8,    10,    26,    17,    15,
      15,     3,     4,     5,     6,    15,     8,     8,    10,    26,
      26,    26,    26
};
...
#line 84 "parser.y"
    {    
              int i;
              i=symbolLookup((yyvsp[(3) - (3)].string));
              if(i!=-1) printf("\n Symbol with the same identifer before has already been parsed");
                            else addToSymbolTable((yyvsp[(3) - (3)].string),(yyvsp[(0) - (3)].string),0);
                  }
    break;
...
#line 91 "parser.y"
    {
                      int i;
                      i=symbolLookup((yyvsp[(1) - (3)].string));
                      if(i!=-1) printf("\n Symbol with the same identifier before has already been parsed");
                      else addToSymbolTable((yyvsp[(1) - (3)].string),(yyvsp[(0) - (3)].string),(yyvsp[(3) - (3)].numberVar));
                    }
    break;
...
#line 98 "parser.y"
    {
                                  int i;
                                  i=symbolLookup((yyvsp[(3) - (5)].string));
                                  if(i!=-1) printf("\n Symbol with the same identifier before has already been parsed");
                                  else addToSymbolTable((yyvsp[(3) - (5)].string),(yyvsp[(0) - (5)].string),(yyvsp[(5) - (5)].numberVar));   
                               }
    break;
...
#line 105 "parser.y"
    {
          int i;
                i=symbolLookup((yyvsp[(1) - (1)].string));
                if(i!=-1) printf("\n Symbol with the same identifer before has already been parsed");
                else addToSymbolTable((yyvsp[(1) - (1)].string),(yyvsp[(0) - (1)].string),0);
            }
    break;
...
#line 117 "parser.y"
    {
                                      int i;
                                      i=symbolLookup((yyvsp[(1) - (4)].string));
                                        if(i==-1){
                                          printf("\n Invalid input. Please check the syntax on line: %d\n", yylineno-1);
                                        } else {
                                                  char temp[10];
                                                    if(strcmp(storedSymbol[i].inputType,"int")==0){
                                                      sprintf(temp,"%d",(int)(yyvsp[(3) - (4)].numberVar));
                                                    } else snprintf(temp,10,"%f",(yyvsp[(3) - (4)].numberVar));
                                                codeGenContents("=","",temp,(yyvsp[(1) - (4)].string));
                                              }
                                      }
    break;
...
#line 130 "parser.y"
    {
                        ...
                        firstInput=symbolLookup((yyvsp[(1) - (4)].string));
                        secondInput=symbolLookup((yyvsp[(3) - (4)].string));
                        if(firstInput==-1 || secondInput==-1){
                        printf("\n Invalid input. Please check the syntax on line: %d\n", yylineno-1);
                        } else codeGenContents("=","",(yyvsp[(3) - (4)].string),(yyvsp[(1) - (4)].string));                  
                      }
    break;
...
#line 140 "parser.y"
    { 
                        codeGenContents("=","",stackPop(),(yyvsp[(1) - (4)].string));
                      }
    break;
...
#line 179 "parser.y"
    {   
                    ...
                    } else stackPush((yyvsp[(1) - (1)].string));         
                }
    break;
...
#line 187 "parser.y"
    {
                  char temp[10];
                    snprintf(temp,10,"%f",(yyvsp[(1) - (1)].numberVar));    
                    stackPush(temp);                 
                }
    break;
